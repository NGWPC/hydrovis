...
DROP TABLE IF EXISTS publish.mrf_nbm_max_inundation_10day_bridge_threats;
...
FROM cache.max_flows_mrf_nbm_10day AS flows
...
select mc.*
INTO publish.mrf_nbm_max_inundation_10day_bridge_threats
FROM (
	select osmid, 
...
ALTER TABLE publish.mrf_nbm_max_inundation_10day_bridge_threats;
DROP COLUMN oid;

...
DROP TABLE IF EXISTS publish.ana_past_7day_max_inundation_bridge_threats;
...
FROM cache.max_flows_ana_7day AS flows
...
select mc.*
INTO publish.ana_past_7day_max_inundation_bridge_threats
FROM (
	select osmid, 
...
ALTER TABLE publish.ana_past_7day_max_inundation_bridge_threats;
DROP COLUMN oid;

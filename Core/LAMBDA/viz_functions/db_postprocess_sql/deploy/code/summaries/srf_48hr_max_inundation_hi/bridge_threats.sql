...
DROP TABLE IF EXISTS publish.srf_48hr_max_inundation_hi_bridge_threats;
...
FROM cache.max_flows_srf_hi AS flows
...
select mc.*
INTO publish.srf_48hr_max_inundation_hi_bridge_threats
FROM (
	select osmid, 
...
ALTER TABLE publish.srf_48hr_max_inundation_hi_bridge_threats
DROP COLUMN oid;

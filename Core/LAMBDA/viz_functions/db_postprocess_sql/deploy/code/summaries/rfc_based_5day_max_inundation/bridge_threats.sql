...
DROP TABLE IF EXISTS publish.rfc_based_5day_max_inundation_bridge_threats;
...
FROM cache.max_flows_rnr AS flows
...
select mc.*
INTO publish.rfc_based_5day_max_inundation_bridge_threats
FROM (
	select osmid, 
...
ALTER TABLE publish.rfc_based_5day_max_inundation_bridge_threats;
DROP COLUMN oid;

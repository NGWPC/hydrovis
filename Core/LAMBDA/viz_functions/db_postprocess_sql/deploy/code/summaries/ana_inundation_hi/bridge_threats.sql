...
DROP TABLE IF EXISTS publish.ana_inundation_hi_bridge_threats;
...
FROM cache.max_flows_ana_hi AS flows
...
select mc.*
INTO publish.ana_inundation_hi_bridge_threats
FROM (
	select osmid, 
...
ALTER TABLE publish.ana_inundation_hi_bridge_threats
DROP COLUMN oid;

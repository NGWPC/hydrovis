...
DROP TABLE IF EXISTS publish.mrf_gfs_max_inundation_5day_bridge_threats;
...
FROM cache.max_flows_mrf_gfs_5day AS flows
...
select mc.*
INTO publish.mrf_gfs_max_inundation_5day_bridge_threats
FROM (
	select osmid, 
...
ALTER TABLE publish.mrf_gfs_max_inundation_5day_bridge_threats;
DROP COLUMN oid;

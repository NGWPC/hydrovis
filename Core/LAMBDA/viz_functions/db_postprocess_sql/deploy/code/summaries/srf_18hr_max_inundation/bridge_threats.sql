...
DROP TABLE IF EXISTS publish.srf_18hr_max_inundation_bridge_threats;
...
FROM cache.max_flows_srf AS flows
...
select mc.*
INTO publish.srf_18hr_max_inundation_bridge_threats
FROM (
	select osmid, 
...
ALTER TABLE publish.srf_18hr_max_inundation_bridge_threats
DROP COLUMN oid;
